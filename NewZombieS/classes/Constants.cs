...
namespace Zombie_Slayer
{
    public static class Constants
    {
        ...
        //big zombie
        public const int BigZombieSizeWidth = 150;
        public const int BigZombieSizeHeight = 150;

        public const int BigZombieHealth = 2;

        public const int BigZombieSpeed = 1;
        public const int BigZombieDammage = 3;


        ///////////////////////////Dragon///////////////////////////

        public const int dragonSizeWidth = 250;
        public const int dragonSizeHeight = 250;

        public const int dragonHealth = 20;

        public const int dragonSpeed = 1;
        public const int dragonDammage = 5;
